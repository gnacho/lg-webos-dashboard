...
The **Advanced** tab, `/?tab=advanced`, holds the TV's own settings that LG keeps several menus deep: Quick Boot, Wake-on-LAN, staying connected when off, the LG logo shown at power on and off, and the front lights. Each setting appears only on TVs that have it. On the TV itself they are under **System**.
